...
/**
 * função converte texto para array
 *  @param   string
 *  @return  array
 */
function convertTextInArray($string){
	$array = explode(" ", $string);
 	return $array;
}

/**
 * função retorna um array com palavras de 5 letras
 *  @param   string
 *  @return  array
 */
function countWordGroup($string){
	$array_text = convertTextInArray($string);

	return array_filter($array_text, function ($value) {
			return strlen($value) == 5;
		});
}

/**
 * função retorna um array com palavras de 8 ou mais letras
 *  @param   string
 *  @return  array
 */
function countVerbsBooglan($string){
	$array_text = convertTextInArray($string);
...
/**
 * função retorna um array com palavras que possuem o final com as letras r, t, c, d e b
 *  @param   array
 *  @return  array
 */
function counterLetter($array){
	$pattern = ['r', 't', 'c', 'd', 'b'];

	return array_filter($array, function ($value) use ($pattern) {
		return in_array(substr($value, -1), $pattern);
	});
}
 ...
 *  @return  array
 */
function counterLetterForVerbs($array){
	$pattern = ['r', 't', 'c', 'd', 'b'];

	return array_filter($array, function ($value) use ($pattern) {
		return in_array(substr($value, 0, 1), $pattern);
	});
}

/**
 * função retorna um array sem a ocorrencia da letra 'L'
 * @param   array
 * @return  array
 */
function letterOccurrenceL($array){
	foreach ($array as $key => $palavra) {
		$pos = strpos($palavra, 'l');
...
/**
 * função retorna um array sem a ocorrencia de palavras duplicadas
 * @param   string
 * @return  array
 */
function removeDuplicates($string){
	...
	return array_unique($array_text);
}


//Exercicio 01
$array_bar = countWordGroup($texto);
$array_bar_five = counterLetter($array_bar);
$bar = letterOccurrenceL($array_bar_five);
printf("Array com palavras Booglan<br>");
echo "<pre>"; print_r(count($bar)); echo '</pre>'; //12 palavras
echo "<pre>"; print_r($bar); echo '</pre>';

//Exercicio 02
$array_verbs = countVerbsBooglan($texto);
$array_verbs = counterLetter($array_verbs);
printf("<br>Array com os verbos<br>");
echo '<pre>';print_r(count($array_verbs)); echo '</pre>';// 29 verbos
echo '<pre>';print_r($array_verbs); echo '</pre>';

$array_first_person_verbs = counterLetterForVerbs($array_verbs);
printf("<br>Array com os verbos em primeira pessoa<br>");
echo '<pre>';print_r(count($array_first_person_verbs)); echo '<pre>';// 5 verbos em primeira pessoa
echo '<pre>';print_r($array_first_person_verbs); echo '<pre>';

//Exercicio 03
$array_vocabulary = removeDuplicates($texto);
printf("<br>Array sem elementos duplicados<br>");
echo '<pre>';print_r(count($array_vocabulary)); echo '<pre>'; // 599 palavras
